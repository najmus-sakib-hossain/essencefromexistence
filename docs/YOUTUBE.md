...
* **Channel Name:** essencefromexistence
...
**Narrator:** And thus, essencefromexistence was born. A channel dedicated to exploring the universe, one questionable theory at a time. I mean, who needs a fancy logo when you can have a minimalist masterpiece like this?
...
<!-- Make funny and solve grammar mistakes this youtube video script or moreover the written plan for my youtube channel called essencefromexistence, It is the introduction video of this channel and also states as I am a shy guy that why I will hardly use my own voice but won't show my face, name or other info and will make a anitions image but for now I will just go with a black color with face on it just to start youtube :- this plan uses the creation of everthing in the scince way using quantum mechanics and big bang thery then shows the extintion of dinorsours and then the evolution of humans till the time he is creating the youtube channel it also says this sciencetific theory can be completely wrong by just to respect every religion belifs: 
