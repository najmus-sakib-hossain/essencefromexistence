...
You can use any framework that supports React. [Next.js](https://ui.essencefromexistence.com/docs/installation/next), [Astro](https://ui.essencefromexistence.com/docs/installation/astro), [Remix](https://ui.essencefromexistence.com/docs/installation/remix), [Gatsby](https://ui.essencefromexistence.com/docs/installation/gatsby) etc.
